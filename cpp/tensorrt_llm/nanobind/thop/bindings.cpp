...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("rope_append") = std::nullopt, nb::arg("mrope_rotary_cos_sin") = std::nullopt,
        nb::arg("mrope_position_deltas") = std::nullopt, nb::arg("helix_tensor_params"),
        ...
        nb::arg("sparse_attn_indices_block_size"), nb::arg("sparse_mla_topk") = std::nullopt,
