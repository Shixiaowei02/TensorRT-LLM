    ...
    auto ContextPhaseParamsSetState = [](py::tuple const& state)
    {
        ...
        if (!state[2].is_none())
        {
            ...
            return std::make_unique<tle::ContextPhaseParams>(state[0].cast<VecTokens>(),
                ...
                state[3].cast<std::optional<VecTokens>>(), state[4].cast<std::optional<std::string>>(),
        ...
        return std::make_unique<tle::ContextPhaseParams>(state[0].cast<VecTokens>(),
            ...
            state[4].cast<std::optional<std::string>>(), state[5].cast<std::optional<std::string>>());
    };
        ...
        .def(
            py::init(
                [](VecTokens const& first_gen_tokens, tle::ContextPhaseParams::RequestIdType req_id,
                    ...
                    std::optional<std::string> const& disagg_id, std::optional<std::string> const& disagg_info_endpoint)
                {
                    if (opaque_state)
                    {
