...
std::optional<std::string> const& ContextPhaseParams::getDisaggId() const noexcept
{
    return mDisaggId;
}

void ContextPhaseParams::setDisaggId(std::optional<std::string> disaggId) noexcept
{
    mDisaggId = std::move(disaggId);
}
