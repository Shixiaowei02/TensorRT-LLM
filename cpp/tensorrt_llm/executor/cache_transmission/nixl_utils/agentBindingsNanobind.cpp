...
NB_MODULE(tensorrt_llm_transfer_agent_binding, m)
{
    ...
    nb::class_<kvc::NixlTransferStatus, kvc::TransferStatus>(m, "NixlTransferStatus")
        ...
        .def("wait", &kvc::NixlTransferStatus::wait, nb::call_guard<nb::gil_scoped_release>())
        .def("wait_with_status", &kvc::NixlTransferStatus::waitWithStatus, nb::call_guard<nb::gil_scoped_release>());
