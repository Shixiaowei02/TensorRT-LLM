...
PYBIND11_MODULE(tensorrt_llm_transfer_agent_binding, m)
{
    ...
    py::class_<kvc::TransferStatus>(m, "TransferStatus")
        ...
        .def("wait", &kvc::TransferStatus::wait);
    ...
    py::class_<kvc::NixlTransferStatus, kvc::TransferStatus>(m, "NixlTransferStatus")
        ...
        .def("wait", &kvc::NixlTransferStatus::wait, py::call_guard<py::gil_scoped_release>())
        .def("wait_with_status", &kvc::NixlTransferStatus::waitWithStatus, py::call_guard<py::gil_scoped_release>());
